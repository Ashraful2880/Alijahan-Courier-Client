		...
		<Modal
			...
			<Fade in={opens}>
				<Box sx={style}>
					...
					<Box style={{ position: "absolute", top: "63px", left: "30%", zIndex: "999" }}>
						<ReactToPrint
							trigger={() =>
								<Badge badgeContent={selectionModel?.length} color="secondary">
									<PrintIcon onClick={() => printData()} style={{ color: "#166534", cursor: "pointer" }} />
								</Badge>
							}
							content={() => ref}
							pageStyle="print"
